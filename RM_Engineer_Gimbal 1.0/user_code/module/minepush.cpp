...
void MinePush::init()
{
    ...
    {
        //设置初始值
        stretch_motor_start_angle[i] = mine_motive_motor[i].total_angle;
    ...
    // 电机软件限位，需要测试后开启
    // mine_motive_motor[MINE_STRETCH_L_ID].max_angle = stretch_motor_start_angle[MINE_STRETCH_L_ID] + STRENTCH_LIMIT_ANGLE;
    // mine_motive_motor[MINE_STRETCH_L_ID].min_angle = stretch_motor_start_angle[MINE_STRETCH_L_ID];

    // mine_motive_motor[MINE_STRETCH_R_ID].max_angle = stretch_motor_start_angle[MINE_STRETCH_R_ID];
    // mine_motive_motor[MINE_STRETCH_R_ID].min_angle = stretch_motor_start_angle[MINE_STRETCH_R_ID] - STRENTCH_LIMIT_ANGLE;
...
void MinePush::feedback_update(){
    ...
    for (uint8_t i = 0; i < 4; ++i)
    {
        ...
        mine_motive_motor[i].total_angle = mine_motive_motor[i].motor_measure->total_angle - stretch_motor_start_angle[i];
...
void MinePush::motor_set_control(Joint_motors *motor)
{
    if (motor == NULL)
    {
        return;
